...
function levelThree(){
    ...
    //defined in the levelTwoInter using the for loop (line 4-6, level_three.js)//
    //////////////////////////////////////////////////
    background(255, 150, 150);
    image(imgs[6],0,0,width,height)//background changes AS LEVEL changes
  ...
  text("Level Three", width/2-50,30);
  text("Hits:" + kCounter, 10, 53);
  text("Total" + kCounterHold, 10,84)
    
  if(kCounter>26 && state == levelThree){
